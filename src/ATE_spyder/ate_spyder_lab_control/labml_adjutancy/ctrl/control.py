...
class Control(QtWidgets.QDialog):
    ...
    def adjustUI(self):
        ...
        # set connect:
        self.RBdebug.clicked.connect(lambda: self.logging(self.logging_cmd_reload))
        self.RBmeasure.clicked.connect(lambda: self.logging(self.logging_cmd_reload))
        self.RBinfo.clicked.connect(lambda: self.logging(self.logging_cmd_reload))
        self.RBwarning.clicked.connect(lambda: self.logging(self.logging_cmd_reload))
        self.RBerror.clicked.connect(lambda: self.logging(self.logging_cmd_reload))
        #        self.actionsave_mqtt_to_file.triggered.connect(lambda: self.guiclicked('mqtt'))
        self.CBholdonbreak.clicked.connect(lambda: self.saveconfig("holdonbreak"))  # CB = QCheckBox
        self.CBstartauto.clicked.connect(self.saveconfig)
        self.CBstopauto.clicked.connect(self.saveconfig)
        self.CBstoponfail.clicked.connect(
    ...
    def blockSignals(self, value):
        self.CBstoponfail.blockSignals(value)
        self.CBstartauto.blockSignals(value)
        self.CBstopauto.blockSignals(value)
        self.CBholdonbreak.blockSignals(value)
        self.RBdebug.blockSignals(value)
        self.RBmeasure.blockSignals(value)
        self.RBinfo.blockSignals(value)
        self.RBwarning.blockSignals(value)
        self.RBerror.blockSignals(value)
        self.rb_onlyerrorAction.blockSignals(value)
        self.rb_allAction.blockSignals(value)
        self.rb_lastAction.blockSignals(value)
