...
class Plugin:
    ...
    def get_configuration_options(object_name):
        if Plugin.prefix() in object_name:
            ...
            return Plugin.parameter[object_name]
...
class SemiCtrl(mqtt_deviceattributes):
    """
    Class for the Communication with Semi-Ctrl.
    ...
    def _setData(self, data):
        # data = ['Log level']
        parameter = Plugin.parameter["SemiCtrl.Control"]
