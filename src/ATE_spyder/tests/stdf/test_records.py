...
# TODO: Remove this test file as it does nothing but testing the 
# external package Semi-ATE-STDF itself, i.e. these tests should be
# located in Semi-ATE-STDF project.
