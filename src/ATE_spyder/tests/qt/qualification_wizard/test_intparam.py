import ate_spyder.widgets.actions_on.flow.qualificationwizardbase.wizardbase
from ate_spyder.widgets.actions_on.flow.qualificationwizardbase.intparam import IntParam
...
from tests.qt.qualification_wizard.mock_db_object import MockDBObject
...
def test_int_param_save_values_stores_value(window, qtbot):
    testParam = ate_spyder.widgets.actions_on.flow.qualificationwizardbase.intparam.IntParam("Parameter32", 17, 10, 20)
