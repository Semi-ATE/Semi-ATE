...
from ate_spyder.widgets.actions_on.flow.qualificationwizardbase.optionparam import OptionParam
...
def test_int_param_save_values_stores_value(window, qtbot):
    testParam = ate_spyder.widgets.actions_on.flow.qualificationwizardbase.optionparam.OptionParam("Parameter32", ["A", "B", "C"])
