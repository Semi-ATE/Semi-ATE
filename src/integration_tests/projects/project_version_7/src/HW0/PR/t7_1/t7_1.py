...
if __name__ == '__main__':
    from t7_1_BC import t7_1_BC
else:
    from t7_1.t7_1_BC import t7_1_BC
...
class t7_1(t7_1_BC):
    ...
    ip.in_1         |  No   | 10.000 | 10.000  | 100.000 | A    | .3f

    Parameter         | MPR | LSL |    (LTL) |  Nom  | (UTL)  | USL  | Unit | fmt
    ------------------+-----+-----+----------+-------+--------+------+------+----
    op.out_1          | No  |  -∞ |  -50.000 | 0.000 | 50.000 | +∞   | V    | .3f
    op.out_2          | Yes |  -∞ | -100.000 | 0.000 | 0.000  | +∞   | A    | .3f
    </do_not_touch>
