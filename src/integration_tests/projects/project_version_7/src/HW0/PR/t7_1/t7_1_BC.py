...
If you have the need to add things, add it to 't7_1.py' or 'common.py'
...
class t7_1_OP:
    """Class definition for the output parameters of t7_1."""

    def __init__(self):
        self.num_outputs = 0
        self.out_1 = OutputParameter('out_1', -inf, -50.0, 0.0, 50.0, inf, -3)
        self.out_1.set_format('.3f')
        self.out_1.set_unit('V')
        self.out_1.set_mpr(False)
        self.out_2 = OutputParameter('out_2', -inf, -100.0, 0.0, 0.0, inf, 0)
        self.out_2.set_format('.3f')
        self.out_2.set_unit('A')
        self.out_2.set_mpr(True)
...
class t7_1_IP:
    """Class definition for the input parameters of t7_1."""
...
class t7_1_BC(DutTestCaseBase):
    '''Base class definition for t7_1'''
