...
If you have the need to add things, add it to 'fae.py' or 'common.py'
...
class fae_OP:
    """Class definition for the output parameters of fae."""

    def __init__(self):
        self.num_outputs = 0
        self.new_parameter1 = OutputParameter('new_parameter1', -inf, nan, 0.0, nan, inf, 0, False)
...
class fae_IP:
    """Class definition for the input parameters of fae."""
...
class fae_BC(DutTestCaseBase):
    '''Base class definition for fae'''
    ...
    def aggregate_test_result(self, site_num: int, exception: bool):
        ...
        if not exception:
            ...
            stdf_data.append(self.op.new_parameter1.generate_stdf_result_record(current_result[0], site_num))
        else:
            test_result = Result.Fail()
            test_bin = self.get_sbin()
            stdf_data.append(self.op.new_parameter1.generate_stdf_result_record(test_result, site_num))
