...
if __name__ == '__main__':
    from NewFT_only_BC import NewFT_only_BC
else:
    from NewFT_only.NewFT_only_BC import NewFT_only_BC


class NewFT_only(NewFT_only_BC):
    ...
    def do(self):
        """Default implementation for the 'NewFT_only' test."""
