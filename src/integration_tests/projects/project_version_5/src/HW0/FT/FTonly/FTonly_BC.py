...
If you have the need to add things, add it to 'FTonly.py' or 'common.py'
...
class FTonly_OP:
    """Class definition for the output parameters of FTonly."""
...
class FTonly_IP:
    """Class definition for the input parameters of FTonly."""
...
class FTonly_BC(DutTestCaseBase):
    '''Base class definition for FTonly'''
