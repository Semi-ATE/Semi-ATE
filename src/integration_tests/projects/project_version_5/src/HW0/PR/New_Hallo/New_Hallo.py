...
if __name__ == '__main__':
    from New_Hallo_BC import New_Hallo_BC
else:
    from New_Hallo.New_Hallo_BC import New_Hallo_BC


class New_Hallo(New_Hallo_BC):
    ...
    def do(self):
        """Default implementation for the 'New_Hallo' test."""
