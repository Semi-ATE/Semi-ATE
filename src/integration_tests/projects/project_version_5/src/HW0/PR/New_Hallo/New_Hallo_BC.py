...
If you have the need to add things, add it to 'New_Hallo.py' or 'common.py'
...
class New_Hallo_OP:
    """Class definition for the output parameters of New_Hallo."""
...
class New_Hallo_IP:
    """Class definition for the input parameters of New_Hallo."""
...
class New_Hallo_BC(DutTestCaseBase):
    '''Base class definition for New_Hallo'''
    ...
    def __init__(self, instance_name: str, context):
        ...
        self.ip = New_Hallo_IP()
        self.op = New_Hallo_OP()
        self._sbin = None
        self._test_num = None
