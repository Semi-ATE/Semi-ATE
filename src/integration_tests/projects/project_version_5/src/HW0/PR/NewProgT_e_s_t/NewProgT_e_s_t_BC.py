...
If you have the need to add things, add it to 'NewProgT_e_s_t.py' or 'common.py'
...
class NewProgT_e_s_t_OP:
    """Class definition for the output parameters of NewProgT_e_s_t."""
...
class NewProgT_e_s_t_IP:
    """Class definition for the input parameters of NewProgT_e_s_t."""
...
class NewProgT_e_s_t_BC(DutTestCaseBase):
    '''Base class definition for NewProgT_e_s_t'''
    ...
    def __init__(self, instance_name: str, context):
        ...
        self.ip = NewProgT_e_s_t_IP()
        self.op = NewProgT_e_s_t_OP()
        self._sbin = None
        self._test_num = None
