...
if __name__ == '__main__':
    from NewProgT_e_s_t_BC import NewProgT_e_s_t_BC
else:
    from NewProgT_e_s_t.NewProgT_e_s_t_BC import NewProgT_e_s_t_BC


class NewProgT_e_s_t(NewProgT_e_s_t_BC):
    ...
    def do(self):
        """Default implementation for the 'NewProgT_e_s_t' test."""
