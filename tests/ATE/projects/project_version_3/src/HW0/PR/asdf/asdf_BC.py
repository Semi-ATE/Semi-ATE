...
If you have the need to add things, add it to 'asdf.py' or 'common.py'
...
class asdf_OP:
    """Class definition for the output parameters of asdf."""
...
class asdf_IP:
    """Class definition for the input parameters of asdf."""
...
class asdf_BC(DutTestCaseBase):
    '''Base class definition for asdf'''
