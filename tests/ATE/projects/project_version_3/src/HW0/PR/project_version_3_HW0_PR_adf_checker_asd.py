...
if __name__ == '__main__':
    ...
    from project_version_3_HW0_PR_adf_checker_asd_auto_script import AutoScript
    ...
    from asdf.asdf import asdf
    _ate_var_asdf_1 = asdf("asdf_1", context)
    _ate_var_asdf_1.set_sbin(60000)
    _ate_var_asdf_1.set_test_num(100)

    _ate_var_asdf_1.ip.set_parameter('Temperature', 'static', 25, -40.0, 170.0, 0, context)

    _ate_var_asdf_1.op.set_parameter('new_parameter1', 101, nan, nan, 11, 2, 'asdf_1')

    sequencer.register_test(_ate_var_asdf_1)
