...
If you have the need to add things, add it to 'ad.py' or 'common.py'
...
class ad_OP:
    """Class definition for the output parameters of ad."""
...
class ad_IP:
    """Class definition for the input parameters of ad."""
...
class ad_BC(DutTestCaseBase):
    '''Base class definition for ad'''
