...
If you have the need to add things, add it to 'df.py' or 'common.py'
...
class df_OP:
    """Class definition for the output parameters of df."""
...
class df_IP:
    """Class definition for the input parameters of df."""
...
class df_BC(DutTestCaseBase):
    '''Base class definition for df'''
