...
if __name__ == '__main__':
    ...
    from project_version_4_HW0_FT_aaa_production_proc_2_auto_script import AutoScript
    ...
    from abcedefg.abcedefg import abcedefg
    _ate_var_abcedefg_1 = abcedefg("abcedefg_1", context)
    _ate_var_abcedefg_1.set_sbin(60000)
    _ate_var_abcedefg_1.set_test_num(100)

    _ate_var_abcedefg_1.ip.set_parameter('Temperature', 'static', 25, -40.0, 170.0, 0, context)

    _ate_var_abcedefg_1.op.set_parameter('new_parameter1', 101, nan, nan, 11, 2, 'abcedefg_1')

    sequencer.register_test(_ate_var_abcedefg_1)
