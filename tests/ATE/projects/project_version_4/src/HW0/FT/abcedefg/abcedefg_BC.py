...
If you have the need to add things, add it to 'abcedefg.py' or 'common.py'
...
class abcedefg_OP:
    """Class definition for the output parameters of abcedefg."""
...
class abcedefg_IP:
    """Class definition for the input parameters of abcedefg."""
...
class abcedefg_BC(DutTestCaseBase):
    '''Base class definition for abcedefg'''
