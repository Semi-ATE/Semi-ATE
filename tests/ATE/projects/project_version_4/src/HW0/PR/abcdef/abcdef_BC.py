...
If you have the need to add things, add it to 'abcdef.py' or 'common.py'
...
class abcdef_OP:
    """Class definition for the output parameters of abcdef."""
...
class abcdef_IP:
    """Class definition for the input parameters of abcdef."""
...
class abcdef_BC(DutTestCaseBase):
    '''Base class definition for abcdef'''
