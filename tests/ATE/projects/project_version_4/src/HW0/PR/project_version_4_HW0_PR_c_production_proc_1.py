...
if __name__ == '__main__':
    ...
    from project_version_4_HW0_PR_c_production_proc_1_auto_script import AutoScript
    ...
    from abcdef.abcdef import abcdef
    _ate_var_abcdef_1 = abcdef("abcdef_1", context)
    _ate_var_abcdef_1.set_sbin(60000)
    _ate_var_abcdef_1.set_test_num(100)

    _ate_var_abcdef_1.ip.set_parameter('Temperature', 'static', 25, -40.0, 170.0, 0, context)

    _ate_var_abcdef_1.op.set_parameter('new_parameter1', 101, nan, nan, 11, 2, 'abcdef_1')

    sequencer.register_test(_ate_var_abcdef_1)
