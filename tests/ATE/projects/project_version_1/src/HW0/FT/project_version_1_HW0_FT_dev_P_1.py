...
if __name__ == '__main__':
    ...
    _ate_var_iddq_1.set_test_num(1)

    _ate_var_iddq_1.ip.set_parameter('Temperature', 'static', 25, -40.0, 170.0, 0, context)

    _ate_var_iddq_1.op.set_parameter('new_parameter1', 0, nan, nan, 11, 2, 'iddq_1')

    sequencer.register_test(_ate_var_iddq_1)
    from iddq.iddq import iddq
    _ate_var_iddq_2 = iddq(context)
    _ate_var_iddq_2.set_sbin(60001)
    _ate_var_iddq_2.set_test_num(3)

    _ate_var_iddq_2.ip.set_parameter('Temperature', 'static', 25, -40.0, 170.0, 0, context)

    _ate_var_iddq_2.op.set_parameter('new_parameter1', 2, nan, nan, 11, 2, 'iddq_2')

    sequencer.register_test(_ate_var_iddq_2)
    from iddq.iddq import iddq
    _ate_var_iddq_3 = iddq(context)
    _ate_var_iddq_3.set_sbin(60002)
    _ate_var_iddq_3.set_test_num(5)

    _ate_var_iddq_3.ip.set_parameter('Temperature', 'static', 25, -40.0, 170.0, 0, context)

    _ate_var_iddq_3.op.set_parameter('new_parameter1', 4, nan, nan, 11, 2, 'iddq_3')

    sequencer.register_test(_ate_var_iddq_3)
