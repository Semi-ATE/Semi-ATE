...
if __name__ == '__main__':
    ...
    _ate_var_contact_1.set_test_num(1)

    _ate_var_contact_1.ip.set_parameter('Temperature', 'static', 25, -40.0, 170.0, 0, context)

    _ate_var_contact_1.op.set_parameter('new_parameter1', 0, nan, nan, 11, 2, 'contact_1')

    sequencer.register_test(_ate_var_contact_1)
    from contact.contact import contact
    _ate_var_contact_2 = contact(context)
    _ate_var_contact_2.set_sbin(60001)
    _ate_var_contact_2.set_test_num(3)

    _ate_var_contact_2.ip.set_parameter('Temperature', 'static', 25, -40.0, 170.0, 0, context)

    _ate_var_contact_2.op.set_parameter('new_parameter1', 2, nan, nan, 11, 2, 'contact_2')

    sequencer.register_test(_ate_var_contact_2)
