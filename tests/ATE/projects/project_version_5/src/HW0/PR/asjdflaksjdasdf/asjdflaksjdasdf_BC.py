...
If you have the need to add things, add it to 'asjdflaksjdasdf.py' or 'common.py'
...
class asjdflaksjdasdf_OP:
    """Class definition for the output parameters of asjdflaksjdasdf."""
...
class asjdflaksjdasdf_IP:
    """Class definition for the input parameters of asjdflaksjdasdf."""
...
class asjdflaksjdasdf_BC(DutTestCaseBase):
    '''Base class definition for asjdflaksjdasdf'''
    ...
    def __init__(self, instance_name: str, context):
        ...
        self.ip = asjdflaksjdasdf_IP()
        self.op = asjdflaksjdasdf_OP()
        self._sbin = None
        self._test_num = None
