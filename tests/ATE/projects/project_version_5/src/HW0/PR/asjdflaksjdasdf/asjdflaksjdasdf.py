...
# -*- coding: utf-8 -*-
"""
By alenz (alenz@awinia.lan)
"""
if __name__ == '__main__':
    from asjdflaksjdasdf_BC import asjdflaksjdasdf_BC
else:
    from asjdflaksjdasdf.asjdflaksjdasdf_BC import asjdflaksjdasdf_BC


class asjdflaksjdasdf(asjdflaksjdasdf_BC):
    ...
    def do(self):
        """Default implementation for the 'asjdflaksjdasdf' test."""
