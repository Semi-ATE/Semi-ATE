...
If you have the need to add things, add it to 'NewFT_only.py' or 'common.py'
...
class NewFT_only_OP:
    """Class definition for the output parameters of NewFT_only."""
...
class NewFT_only_IP:
    """Class definition for the input parameters of NewFT_only."""
...
class NewFT_only_BC(DutTestCaseBase):
    '''Base class definition for NewFT_only'''
    ...
    def __init__(self, instance_name: str, context):
        ...
        self.ip = NewFT_only_IP()
        self.op = NewFT_only_OP()
        self._sbin = None
        self._test_num = None
