...
if __name__ == '__main__':
    ...
    _ate_var_iddq_1.set_test_num(2)

    _ate_var_iddq_1.ip.set_parameter('Temperature', 'static', 25, -40.0, 170.0, 0, context)
    _ate_var_iddq_1.ip.set_parameter('new_parameter1', 'static', 0.000, -inf, inf, 0, context)

    _ate_var_iddq_1.op.set_parameter('new_parameter1', 0, nan, nan, 11, 2, 'iddq_1')
    _ate_var_iddq_1.op.set_parameter('new_parameter2', 1, nan, nan, 11, 2, 'iddq_1')
