...
If you have the need to add things, add it to 'contact.py' or 'common.py'
...
class contact_OP:
    """Class definition for the output parameters of contact."""
...
class contact_IP:
    """Class definition for the input parameters of contact."""
...
class contact_BC(DutTestCaseBase):
    '''Base class definition for contact'''
