...
describe('SiteBinInformationComponent', () => {
  ...
  const expectedContainedLabels = ['Part ID', 'Test Head', 'Site', 'BIN', 'S-BIN', 'H-BIN'];
  it('should show expected values for the expected label texts: ' + expectedContainedLabels, () => {
    ...
    let labelAndValueTexts = debugElement.queryAll(By.css('h3')).map(e => e.nativeElement.innerText);
