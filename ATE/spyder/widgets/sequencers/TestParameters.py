...
from ATE.spyder.widgets.sequencers.Utils import (generate_PTR, generate_TSR)
...
class OutputParameter:
    ...
    def generate_ptr_record(self, is_pass):
        return generate_PTR(test_num=self._id + 1, head_num=1, site_num=1,
    ...
    def _generate_valid_tsr_record(self, head_num, site_num, execution_time):
        return generate_TSR(head_num=head_num, site_num=site_num, test_typ='P',
