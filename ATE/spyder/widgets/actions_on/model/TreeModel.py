...
class TreeModel(QtGui.QStandardItemModel):
    ...
    def _reset_flows(self, project_info):
        ...
        if self.base == "FT":
            ...
            self.quali_flows.appendRow(self._make_multi_instance_quali_flow_item(project_info, "ATE.spyder.widgets.actions_on.flow.EC.ecwizard"))
            self.quali_flows.appendRow(self._make_multi_instance_quali_flow_item(project_info, "ATE.spyder.widgets.actions_on.flow.HTOL.htolwizard"))
            self.quali_flows.appendRow(self._make_multi_instance_quali_flow_item(project_info, "ATE.spyder.widgets.actions_on.flow.HTSL.htslwizard"))
            self.quali_flows.appendRow(self._make_multi_instance_quali_flow_item(project_info, "ATE.spyder.widgets.actions_on.flow.DR.drwizard"))
            self.quali_flows.appendRow(self._make_multi_instance_quali_flow_item(project_info, "ATE.spyder.widgets.actions_on.flow.AC.acwizard"))

            self.quali_flows.appendRow(self._make_single_instance_quali_flow_item(project_info, "ATE.spyder.widgets.actions_on.flow.HAST.hastwizard"))
            self.quali_flows.appendRow(self._make_single_instance_quali_flow_item(project_info, "ATE.spyder.widgets.actions_on.flow.ELFR.elfrwizard"))
            self.quali_flows.appendRow(self._make_single_instance_quali_flow_item(project_info, "ATE.spyder.widgets.actions_on.flow.LU.luwizard"))
            self.quali_flows.appendRow(self._make_single_instance_quali_flow_item(project_info, "ATE.spyder.widgets.actions_on.flow.TC.tcwizard"))
            self.quali_flows.appendRow(self._make_single_instance_quali_flow_item(project_info, "ATE.spyder.widgets.actions_on.flow.THB.thbwizard"))

            if not self.project_info.is_package_a_naked_die(package):
                self.quali_flows.appendRow(self._make_multi_instance_quali_flow_item(project_info, "ATE.spyder.widgets.actions_on.flow.ESD.esdwizard"))
    ...
    def _setup_definitions(self):
        from ATE.spyder.widgets.actions_on.hardwaresetup.HardwaresetupItem import HardwaresetupItem
        from ATE.spyder.widgets.actions_on.maskset.MasksetItem import MasksetItem
        from ATE.spyder.widgets.actions_on.die.DieItem import DieItem
        from ATE.spyder.widgets.actions_on.package.PackageItem import PackageItem
        from ATE.spyder.widgets.actions_on.device.DeviceItem import DeviceItem
        from ATE.spyder.widgets.actions_on.product.ProductItem import ProductItem
