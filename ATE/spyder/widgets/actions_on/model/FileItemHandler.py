from ATE.spyder.widgets.actions_on.utils.FileObserver import FileObserver
...
class FileItemHandler:
    ...
    def _append_pattern_item(self):
        from ATE.spyder.widgets.actions_on.patterns.PatternItem import PatternItem
    ...
    def _append_wave_item(self):
        from ATE.spyder.widgets.actions_on.waves.WaveItem import WaveItem
