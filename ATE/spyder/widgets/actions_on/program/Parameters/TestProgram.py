...
class TestParameters:
    def __init__(self, name: str, test_base: str, input_parameters: dict, output_parameters: dict, output_validator: OutputValidator, is_selected: bool = True):
...
class TestProgram:
    ...
    def add_test(self, name: str, test_base: str, input_parameters: dict, output_parameters: dict, is_custom: bool = True):
        if is_custom:
            self._enumerate_tests_if_needed(output_parameters)

        self._tests.append(TestParameters(name, test_base, input_parameters, output_parameters, self.output_validator))

    def _enumerate_tests_if_needed(self, output_parameters: dict):
    ...
    def import_tests_parameters(self, sequence_information):
        for test_info in sequence_information:
            test_parameter = TestParameters(test_info['description'], test_info['name'], test_info['input_parameters'], test_info['output_parameters'], self.output_validator, test_info['is_selected'])
