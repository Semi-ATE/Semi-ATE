...
"""
            self.fields = {
                ...
                "TEST_T": {
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Elapsed test time in milliseconds     ",
                    "Missing": 0,
                },
                "PART_ID": {
                    "#": 12,
    ...
    def to_atdf(self):
        ...
        if v != None and v[0] == "1" and v[1] == "1":
            raise STDFError(
                "export to atdf error: PRR PART_FLG bits 0 and 1 are both set, which is not allowed"
            )
