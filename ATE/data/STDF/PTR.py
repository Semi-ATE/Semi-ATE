...
"""
            self.fields = {
                ...
                "TEST_TXT": {
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Test description text or label        ",
                    "FPE": None,
                    "Missing": "",
                },
                "ALARM_ID": {
                ...
                "OPT_FLAG": {
                    ...
                    "FPE": "self.fields['OPT_FLAG']['Value']!=None",
                    "Missing": 255,
                ...
                "RES_SCAL": {
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Test results scaling exponent         ",
                    "FPE": "self.fields['OPT_FLAG']['Value']!=None",
                    "Missing": 0,
                },
                "LLM_SCAL": {
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Low limit scaling exponent            ",
                    "FPE": "self.fields['OPT_FLAG']['Value']!=None",
                    "Missing": 0,
                },
                "HLM_SCAL": {
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "High limit scaling exponent           ",
                    "FPE": "self.fields['OPT_FLAG']['Value']!=None",
                    "Missing": 0,
                },
                "LO_LIMIT": {
