...
"""
            self.fields = {
                ...
                "PARM_FLG": {
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Parametric test flags (drift, etc.)   ",
                ...
                "RSLT_CNT": {
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Count (k) of returned results         ",
                    "Missing": 0,
                },
                "RTN_STAT": {
                    "#": 10,
                ...
                "RTN_RSLT": {
                    ...
                    "Ref": "RSLT_CNT",
                    "Value": None,
                    "Text": "Array of k returned results           ",
                    "Missing": [],
                },  # RSLT_CNT = 0
                "TEST_TXT": {
                    "#": 12,
                ...
                "OPT_FLAG": {
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Optional data flag See note           ",
                ...
                "RES_SCAL": {
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Test result scaling exponent          ",
                    "Missing": 0,
                },  # OPT_FLAG bit 0 = 1
                "LLM_SCAL": {
                    "#": 16,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Test low limit scaling exponent       ",
                    "Missing": 0,
                },  # OPT_FLAG bit 4 or 6 = 1
                "HLM_SCAL": {
                    "#": 17,
                    "Type": "I*1",
                    "Ref": None,
                    "Value": None,
                    "Text": "Test high limit scaling exponent      ",
                    "Missing": 0,
                },  # OPT_FLAG bit 5 or 7 = 1
                "LO_LIMIT": {
                    "#": 18,
                    "Type": "R*4",
                    "Ref": None,
                    "Value": None,
                    "Text": "Test low limit value                  ",
                    "Missing": 0.0,
                },  # OPT_FLAG bit 4 or 6 = 1
                "HI_LIMIT": {
                    "#": 19,
                ...
                "START_IN": {
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Starting input value [condition]      ",
                    "Missing": 0.0,
                },  # OPT_FLAG bit 1 = 1
                "INCR_IN": {
                    "#": 21,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Increment of input condition          ",
                    "Missing": -1,
                },  # OPT_FLAG bit 1 = 1
                "RTN_INDX": {
                    "#": 22,
                ...
                "UNITS": {
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Units of returned results             ",
                    "Missing": "",
                },
                "UNITS_IN": {
                    "#": 24,
                ...
                "C_RESFMT": {
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "ANSI C result format string           ",
                    "Missing": "",
                },
                "C_LLMFMT": {
                    "#": 26,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "ANSI C low limit format string        ",
                    "Missing": "",
                },
                "C_HLMFMT": {
                    "#": 27,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "ANSI C high limit format string       ",
                    "Missing": "",
                },
                "LO_SPEC": {
                    "#": 28,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Low specification limit value         ",
                    "Missing": 0.0,
                },  # OPT_FLAG bit 2 = 1
                "HI_SPEC": {
                    "#": 29,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "High specification limit value        ",
                    "Missing": 0.0,
                },  # OPT_FLAG bit 3 = 1
            }
        else:
