...
RecordDefinitions = {
    ...
    (0, 10): {
        "V3": ["FAR", "File Attributes Record", [("", False)]],
        "V4": ["FAR", "File Attributes Record", [("", True)]],
    },
    ...
    (0, 30): {
        "V4": [
            ...
            [("V4-2007", True), ("Memory:2010.1", True)],
        ]
    },
    # Data collected on a per lot basis
    (1, 10): {
        "V3": ["MIR", "Master Information Record", [("", True)]],
        "V4": ["MIR", "Master Information Record", [("", True)]],
    },
    (1, 20): {
        "V3": ["MRR", "Master Results Record", [("", True)]],
        "V4": ["MRR", "Master Results Record", [("", True)]],
    },
    (1, 30): {"V4": ["PCR", "Part Count Record", [("", True)]]},
    (1, 40): {
        "V3": ["HBR", "Hardware Bin Record", [("", False)]],
        "V4": ["HBR", "Hardware Bin Record", [("", False)]],
    },
    (1, 50): {
        "V3": ["SBR", "Software Bin Record", [("", False)]],
        "V4": ["SBR", "Software Bin Record", [("", False)]],
    },
    (1, 60): {
        "V3": ["PMR", "Pin Map Record", [("", False)]],
        "V4": ["PMR", "Pin Map Record", [("", False)]],
    },
    ...
    (1, 95): {
        "V4": ["ASR", "Algorithm Specification Record", [("Memory:2010.1", False)]]
    },
    (1, 96): {"V4": ["FSR", "Frame Specification Record", [("Memory:2010.1", False)]]},
    (1, 97): {
        "V4": ["BSR", "Bit stream Specification Record", [("Memory:2010.1", False)]]
    },
    (1, 99): {"V4": ["MSR", "Memory Structure Record", [("Memory:2010.1", False)]]},
    (1, 100): {"V4": ["MCR", "Memory Controller Record", [("Memory:2010.1", False)]]},
    (1, 101): {
        "V4": ["IDR", "Instance Description Record", [("Memory:2010.1", False)]]
    },
    (1, 102): {"V4": ["MMR", "Memory Model Record", [("Memory:2010.1", False)]]},
    # Data collected per wafer
    (2, 10): {
        "V3": ["WIR", "Wafer Information Record", [("", False)]],
        "V4": ["WIR", "Wafer Information Record", [("", False)]],
    },
    (2, 20): {
        "V3": ["WRR", "Wafer Results Record", [("", False)]],
        "V4": ["WRR", "Wafer Results Record", [("", False)]],
    },
    (2, 30): {
        "V3": ["WCR", "Wafer Configuration Record", [("", False)]],
        "V4": ["WCR", "Wafer Configuration Record", [("", False)]],
    },
    # Data collected on a per part basis
    (5, 10): {
        "V3": ["PIR", "Part Information Record", [("", False)]],
        "V4": ["PIR", "Part Information Record", [("", False)]],
    },
    (5, 20): {
        "V3": ["PRR", "Part Results Record", [("", False)]],
        "V4": ["PRR", "Part Results Record", [("", False)]],
    },
    # Data collected per test in the test program
    (10, 30): {
        "V3": ["TSR", "Test Synopsis Record", [("", False)]],
        "V4": ["TSR", "Test Synopsis Record", [("", False)]],
    },
    # Data collected per test execution
    (15, 10): {
        "V3": ["PTR", "Parametric Test Record", [("", False)]],
        "V4": ["PTR", "Parametric Test Record", [("", False)]],
    },
    (15, 15): {"V4": ["MPR", "Multiple-Result Parametric Record", [("", False)]]},
    (15, 20): {
        "V3": ["FTR", "Functional Test Record", [("", False)]],
        "V4": ["FTR", "Functional Test Record", [("", False)]],
    },
    ...
    (20, 10): {
        "V3": ["BPS", "Begin Program Section Record", [("", False)]],
        "V4": ["BPS", "Begin Program Section Record", [("", False)]],
    },
    (20, 20): {
        "V3": ["EPS", "End Program Section Record", [("", False)]],
        "V4": ["EPS", "End Program Section Record", [("", False)]],
    },
    # Generic Data
    (50, 10): {
        "V3": ["GDR", "Generic Data Record", [("", False)]],
        "V4": ["GDR", "Generic Data Record", [("", False)]],
    },
    (50, 30): {
        "V3": ["DTR", "Datalog Text Record", [("", False)]],
        "V4": ["DTR", "Datalog Text Record", [("", False)]],
    },
    # Teradyne extensions
    (180, -1): {
        "V4": ["RR1", "Records Reserved for use by Image software", [("", False)]]
    },
    (181, -1): {
        "V4": ["RR2", "Records Reserved for use by IG900 software", [("", False)]]
    },
}
...
def _stdf_time_field_value_to_string(seconds_since_1970_in_local_time: int):
    return datetime.datetime.fromtimestamp(seconds_since_1970_in_local_time).strftime(
        "%Y-%m-%d %H:%M:%S"
    )
    ...
    if Version in supported().versions():
        ...
        for (REC_TYP, REC_SUB) in RecordDefinitions:
            if Version in RecordDefinitions[(REC_TYP, REC_SUB)]:
                for ext, _obligatory_flag in RecordDefinitions[(REC_TYP, REC_SUB)][
                    Version
                ][2]:
                    if ext in Extensions:
                        retval[(REC_TYP, REC_SUB)] = RecordDefinitions[
                            (REC_TYP, REC_SUB)
                        ][Version][0]
    return retval
...
class STDR(ABC):
    ...
    def __init__(self, endian=None, record=None):
        ...
        self.fields = {
            ...
            "K1": {
                ...
                "Ref": None,
                "Value": None,
                "Text": "One byte unsigned integer reference   ",
                "Missing": 0,
            },
            "K2": {
                "#": 4,
            ...
            "U*1": {
                ...
                "Ref": None,
                "Value": None,
                "Text": "One byte unsigned integer             ",
                "Missing": 0,
            },
            "U*2": {
                "#": 6,
                ...
                "Ref": None,
                "Value": None,
                "Text": "Two byte unsigned integer             ",
                "Missing": 0,
            },
            "U*4": {
                "#": 7,
                ...
                "Ref": None,
                "Value": None,
                "Text": "Four byte unsigned integer            ",
                "Missing": 0,
            },
            "U*8": {
                "#": 8,
                ...
                "Ref": None,
                "Value": None,
                "Text": "Eight byte unsigned integer           ",
                "Missing": 0,
            },
            "U*?": {
                "#": 9,
            ...
            "I*8": {
                ...
                "Ref": None,
                "Value": None,
                "Text": "Eight byte signed integer             ",
                "Missing": 0,
            },
            "R*4": {
                "#": 14,
                ...
                "Ref": None,
                "Value": None,
                "Text": "Four byte floating point number       ",
                "Missing": 0.0,
            },
            "R*8": {
                "#": 15,
                ...
                "Ref": None,
                "Value": None,
                "Text": "Eight byte floating point number      ",
                "Missing": 0.0,
            },
            "C*1": {
                "#": 16,
                ...
                "Ref": None,
                "Value": None,
                "Text": "One byte fixed length string          ",
                "Missing": "1",
            },
            "C*2": {
                "#": 17,
                ...
                "Ref": None,
                "Value": None,
                "Text": "Two byte fixed length string          ",
                "Missing": "12",
            },
            "C*3": {
                "#": 18,
                ...
                "Ref": None,
                "Value": None,
                "Text": "Three byte fixed length string        ",
                "Missing": "123",
            },
            "R*9": {
                "#": 19,
                ...
                "Ref": None,
                "Value": None,
                "Text": "Nine byte fixed length string         ",
                "Missing": "123456789",
            },
            "C*10": {
                "#": 20,
                ...
                "Ref": None,
                "Value": None,
                "Text": "Ten byte (2-digit) fixed length string",
                "Missing": "1234567890",
            }
    ...
    def _default_init(self, endian=None, record=None):
        ...
        if endian == None:
            ...
            raise STDFError(
                "%s object creation error : unsupported endian '%s'" % (self.id, endian)
            )
        # Record
        if record != None:
            if self.local_debug:
    ...
    def __call__(self, endian=None, record=None):
        ...
        if endian != None:
            if (endian == "<") or (endian == ">"):
                ...
                raise STDFError(
                    "%s object creation error : unsupported endian '%s'"
                    % (self.id, endian)
                )
        if record != None:
            self._unpack(record)
    ...
    def get_fields(self, FieldID=None):
        ...
        if FieldID == None:
            ...
            if isinstance(FieldID, str):
                ...
                raise STDFError(
                    "%s.get_fields(%s) Error : '%s' is not a string or integer"
                    % (self.id, FieldID, FieldID)
                )
    ...
    def set_value(self, FieldID, Value):
        ...
        if isinstance(FieldID, int):
            ...
            if FieldKey == "":
                raise STDFError(
                    "%s.set_value(%s, %s) Error : '%s' is not a valid key"
                    % (self.id, FieldID, Value, FieldID)
                )
            ...
            raise STDFError(
                "%s.set_value(%s, %s) : Error : '%s' is not a string or integer."
                % (self.id, FieldID, Value, FieldID)
            )
        ...
        if Type.startswith("x"):
            if not isinstance(Value, list):
                raise STDFError(
                    "%s.set_value(%s, %s) Error : '%s' does not references a list."
                    % (self.id, FieldKey, Value, "*".join((str(K), Type, Bytes)))
                )
            length_type = self.fields[Ref]["Type"]
            if not length_type.startswith("U*"):
                raise STDFError(
                    "%s.set_value(%s, %s) Error : '%s' references a non unsigned integer."
                    % (self.id, FieldKey, Value, "*".join((str(K), Type, Bytes)))
                )
            if not length_type in ["U*1", "U*2", "U*4", "U*8"]:
                raise STDFError(
                    "%s.set_value(%s, %s) Error : '%s' references an unsupported unsigned integer."
                    % (self.id, FieldKey, Value, "*".join((str(K), Type, Bytes)))
                )
            ...
            if Type == "xU":  # list of unsigned integers
                ...
                if Bytes == "1":
                    for index in range(len(Value)):
                        if isinstance(Value[index], int):
                            ...
                            raise STDFError(
                                "%s.set_value(%s, %s) Error : 'index[%s]' is not an integer."
                    ...
                    for index in range(len(Value)):
                        if isinstance(Value[index], int):
                            if (Value[index] >= 0) and (
                                Value[index] <= 18446744073709551615
                            ):
                                temp[index] = Value[index]
                            else:
                                raise STDFError(
                    ...
                    raise STDFError(
                        "%s.set_value(%s, %s) Error : '%s' is an unsupported Type"
                ...
                if self.local_debug:
                    print(
                        "%s._set_value(%s, %s) -> Value = %s, Reference '%s' = %s"
                ...
                if Bytes == "1":
                    ...
                    for index in range(len(Value)):
                        if isinstance(Value[index], int):
                            if (Value[index] >= -36028797018963968) and (
                                Value[index] <= 36028797018963967
                            ):
                                temp[index] = Value[index]
                            else:
                                raise STDFError(
                ...
                if (Bytes == "4") or (Bytes == "8"):
                    for index in range(len(Value)):
                        temp[index] = float(
                            Value[index]
                        )  # no checking for float & double, pack will cast with appropriate precision, cast integers.
                else:
                    raise STDFError(
                        "%s.set_value(%s, %s) Error : '%s' is an unsupported Type"
                        % (self.id, FieldKey, Value, "*".join((Type, Bytes)))
                ...
                if Bytes.isdigit():
                    raise STDFError(
                        "%s.set_value(%s, %s) : Unimplemented type '%s'"
                    ...
                    raise STDFError(
                        "%s.set_value(%s, %s) : Unsupported type '%s'"
                        % (self.id, FieldKey, Value, str(K) + "*".join((Type, Bytes)))
                    )
                self.fields[FieldKey]["Value"] = temp
                self.fields[Ref]["Value"] = len(temp)
                ...
                if Bytes.isdigit():
                    ...
                    temp = [["0"] * (int() * 8)] * len(
                        Value
                    )  # TODO: Fill in the int() statement
                    raise STDFError(
                        "%s.set_value(%s, %s) : Unimplemented type '%s'"
                        % (self.id, FieldKey, Value, str(K) + "*".join((Type, Bytes)))
                    )
                ...
                Type == "xD"
            ):  # list of list of single character strings being '0' and '1'(max length = 65535 bits)
                if Bytes.isdigit():
                    raise STDFError(
                        "%s.set_value(%s, %s) : Unimplemented type '%s'"
                        % (self.id, FieldKey, Value, str(K) + "*".join((Type, Bytes)))
                ...
                if not isinstance(Value, list):
                    raise STDFError(
                        "%s.set_value(%s, %s) : %s should be a list"
                        % (self.id, FieldKey, Value, str(K) + "*".join((Type, Bytes)))
                    )
                for nibble_list in Value:
                    if not isinstance(nibble_list, int):
                        raise STDFError(
                            "%s.set_value(%s, %s) Error : %s should be a list of nibble(s)"
                            % (self.id, FieldKey, Value, "*".join((Type, Bytes)))
                        )
                if Bytes.isdigit():
                    temp = Value
                ...
                Type == "xV"
            ):  # list of tuple (type, value) where type is defined in spec page 62tuples
                """
            ...
            if Type == "U":  # unsigned integer
                if type(Value) not in [int, int]:
                    raise STDFError(
                        "%s.set_value(%s, %s) Error : '%s' is not a an integer"
                ...
                if Bytes == "1":
                    if (Value >= 0) and (Value <= 255):
                        ...
                        raise STDFError(
                            "%s.set_value(%s, %s) Error : '%s' can not be casted into U*1"
                            % (self.id, FieldKey, Value, Value)
                        )
                elif Bytes == "2":
                    if (Value >= 0) and (Value <= 65535):
                        ...
                        raise STDFError(
                            "%s.set_value(%s, %s) Error : '%s' can not be casted into U*2"
                            % (self.id, FieldKey, Value, Value)
                        )
                elif Bytes == "4":
                    if (Value >= 0) and (Value <= 4294967295):
                        ...
                        raise STDFError(
                            "%s.set_value(%s, %s) Error : '%s' can not be casted into U*4"
                            % (self.id, FieldKey, Value, Value)
                        )
                elif Bytes == "8":
                    if (Value >= 0) and (Value <= 18446744073709551615):
                        ...
                        raise STDFError(
                            "%s.set_value(%s, %s) Error : '%s' can not be casted into U*8"
                            % (self.id, FieldKey, Value, Value)
                        )
                else:
                    raise STDFError(
                ...
                if self.local_debug:
                    print(
                        "%s._set_value(%s, %s) -> Value = %s"
                        % (self.id, FieldKey, Value, temp)
                    )

            elif Type == "I":  # signed integer
                if type(Value) not in [int, int]:
                    raise STDFError(
                        "%s.set_value(%s, %s) : '%s' is not an integer"
                        % (self.id, FieldKey, Value, Value)
                    )
                if Bytes == "1":
                    if (Value >= -128) and (Value <= 127):
                        ...
                        raise STDFError(
                            "%s.set_value(%s, %s) : '%s' can not be casted into I*1"
                            % (self.id, FieldKey, Value, Value)
                        )
                elif Bytes == "2":
                    if (Value >= -32768) and (Value <= 32767):
                        ...
                        raise STDFError(
                            "%s.set_value(%s, %s) : '%s' can not be casted into I*2"
                            % (self.id, FieldKey, Value, Value)
                        )
                elif Bytes == "4":
                    if (Value >= -2147483648) and (Value <= 2147483647):
                        ...
                        raise STDFError(
                            "%s.set_value(%s, %s) : '%s' can not be casted into I*4"
                            % (self.id, FieldKey, Value, Value)
                        )
                elif Bytes == "8":
                    if (Value >= -36028797018963968) and (Value <= 36028797018963967):
                        ...
                        raise STDFError(
                            "%s.set_value(%s, %s) : '%s' can not be casted into I*8"
                            % (self.id, FieldKey, Value, Value)
                        )
                else:
                    raise STDFError(
                ...
                if type(Value) not in [float, int, int]:
                    raise STDFError(
                        "%s.set_value(%s, %s) : '%s' is not a float"
                        % (self.id, FieldKey, Value, Value)
                    )
                if (Bytes == "4") or (Bytes == "8"):
                    temp = float(
                        Value
                    )  # no checking for float & double, pack will cast with appropriate precision
                else:
                    raise STDFError(
                        "%s.set_value(%s, %s) : Unsupported type '%s'"
                        % (self.id, FieldKey, Value, "*".join((Type, Bytes)))
                ...
                if not isinstance(Value, str):
                    raise STDFError(
                        "%s.set_value(%s, %s) Error : '%s' is not a python-string"
                        % (self.id, FieldKey, Value, Value)
                    )
                if Bytes.isdigit():
                ...
                Type == "B"
            ):  # list of single character strings being '0' or '1' (max length = 255*8 = 2040 bits)
                if Bytes.isdigit():
                    if (
                        Bytes == "1"
                    ):  # can be a list of '1' and '0' or can be an unsigned 1 character byte
                        temp = ["0"] * 8
                        if isinstance(Value, int):
                            if (Value < 0) or (Value > 255):
                                raise STDFError(
                                    "%s.set_value(%s, %s) : '%s' does contain an non-8-bit integer."
                                    % (
                                        self.id,
                                        FieldKey,
                                        Value,
                            ...
                            if len(Value) != 8:
                                raise STDFError(
                                    "%s.set_value(%s, %s) : '%s' does contain a list of 8 elements."
                                    % (
                                        self.id,
                                        FieldKey,
                                        Value,
                            ...
                            raise STDFError(
                                "%s.set_value(%s, %s) : assignment to 'B*1' is not an integer or list"
                    ...
                    if not isinstance(Value, list):
                        raise STDFError(
                            "%s.set_value(%s, %s) : assignment to '%s' is not a list"
                            % (self.id, FieldKey, Value, "*".join((Type, Bytes)))
                        )
                    ...
                    if result_length % 8 != 0:
                        raise STDFError(
                            "%s.set_value(%s, %s) : '%s' list does not constitute a multiple of 8 bits."
                            % (self.id, FieldKey, Value, "*".join((Type, Bytes)))
                        )
                ...
                Type == "D"
            ):  # list of single character strings being '0' and '1'(max length = 65535 bits)
                if not isinstance(Value, list):
                    raise STDFError(
                        "%s.set_value(%s, %s) Error : '%s' is not a list"
                        % (self.id, FieldKey, Value, Value)
                    )
                if Bytes.isdigit():
                    if int(Bytes) > 65535:
                        raise STDFError(
                            "%s.set_value(%s, %s) Error : type '%s' can't be bigger than 65535 bits"
                            % (self.id, FieldKey, Value, "*".join((Type, Bytes)))
                        )
                    temp = ["0"] * int(Bytes)  # set all bits to '0'
                    if len(Value) > len(temp):
                        raise STDFError(
                            "%s.set_value(%s, %s) Error : too many elements in Value"
                            % (self.id, FieldKey, Value)
                        )
                    for i in range(len(Value)):
                        temp[i] = Value[i]
                ...
                for nibble in Value:
                    if (nibble < 0) or (nibble > 15):
                        raise STDFError(
                            "%s.set_value(%s, %s) Error : a non-nibble value is present in the list."
                            % (self.id, FieldKey, Value)
                        )
                if Bytes.isdigit():
                    if int(Bytes) > 510:
                        raise STDFError(
                            "%s.set_value(%s, %s) Error : type '%s' can't be bigger than 510 nibbles"
                            % (self.id, FieldKey, Value, "*".join((Type, Bytes)))
                        )
                    temp = [0] * int(Bytes)
                    if len(Value) > len(temp):
                ...
                Type == "V"
            ):  # tuple (type, value) where type is defined in spec page 62
                """
                 0 = B*0 Special pad field
                 1 = U*1 One byte unsigned integer
                 2 = U*2 Two byte unsigned integer
                ...
                if not isinstance(Value, tuple):
                    raise STDFError(
                        "%s.set_value(%s, %s) : '%s' is not a tuple",
                        (self.id, FieldKey, Value, "*".join((Type, Bytes))),
                    )
                if len(Value) != 2:
                    raise STDFError(
                        "%s.set_value(%s, %s) : '%s' is not a 2-element tuple",
                        (self.id, FieldKey, Value, "*".join((Type, Bytes))),
                    )
                if Value[0] not in [
                    0,
                    ...
                    raise STDFError(
                        "%s.set_value(%s, %s) : '%s' first element of the tuple is not a recognized",
                        (self.id, FieldKey, Value, "*".join((Type, Bytes))),
                    )
                if Bytes.isdigit():
                    raise STDFError(
    ...
    def _type_size(self, FieldID):
        ...
        if isinstance(FieldID, int):
            ...
            if FieldKey == "":
                raise STDFError(
                    "%s._type_size(%s) : '%s' is not a valid key"
                    % (self.id, FieldID, FieldID)
                )
        elif isinstance(FieldID, str):
            if FieldID not in self.fields:
            ...
            raise STDFError(
                "%s._type_size(%s) : '%s' is not a string or integer."
                % (self.id, FieldID, FieldID)
            )
        ...
        if Type.startswith("x"):
            if (Type == "xU") or (Type == "xI"):
                    ...
                    if self.local_debug:
                        print(
                            ...
                            % (
                                ...
                                FieldKey,
                                retval,
                                str(K) + "*".join((Type, Bytes)),
                            )
                        )
                    return retval
                else:
                    raise STDFError(
                        "%s_type_size(%s) : Unsupported type '%s'"
                ...
                if Bytes.isdigit():
                    ...
                    raise STDFError(
                        "%s._type_size(%s) : Unimplemented type '%s'"
                        % (self.id, FieldKey, str(K) + "*".join((Type, Bytes)))
                    )
                else:
                    raise STDFError(
                ...
                if Bytes.isdigit():
                    ...
                    if self.local_debug:
                        print(
                            "%s._type_size(%s) = %s [%s]"
                            % (self.id, FieldKey, retval, "*".join((Type, Bytes)))
                        )
                    return retval
                elif Bytes == "f":
                    raise STDFError(
            ...
            if (Type == "U") or (Type == "I"):
                ...
                if Bytes.isdigit():
                    ...
                    if bytes_to_pack <= 255:
                        ...
                        raise STDFError(
                            "%s._type_size(%s) : '%s' can not hold more than 255 bytes"
                            % (self.id, FieldKey, "*".join((Type, Bytes)))
                        )
                elif Bytes == "f":
                    raise STDFError(
                ...
                if Bytes.isdigit():
                    ...
                    if bytes_to_pack <= 8192:
                        ...
                        raise STDFError(
                            "%s._type_size(%s) : '%s' can not hold more than 8192 bytes (=65535 bits)"
                            % (self.id, FieldKey, "*".join((Type, Bytes)))
                        )
                elif Bytes == "f":
                    raise STDFError(
    ...
    def _update_rec_len(self):
        ...
        if self.local_debug:
            print("%s._update_rec_len() = %s" % (self.id, reclen))
    ...
    def _pack_item(self, FieldID):
        ...
        if isinstance(FieldID, int):
            ...
            if FieldKey == "":
                raise STDFError(
                    "%s._pack_item(%s) Error : not a valid integer key"
                    % (self.id, FieldID)
                )
        elif isinstance(FieldID, str):
            if FieldID not in self.fields:
                raise STDFError(
                    "%s._pack_item(%s) Error : not a valid string key"
                    % (self.id, FieldID)
                )
            else:
                FieldKey = FieldID
            ...
            raise STDFError(
                "%s._pack_item(%s) Error : not a string or integer key."
                % (self.id, FieldID)
            )

        TypeFormat, Ref, Value = self.get_fields(FieldKey)[
            1:4
        ]  # get Type, Reference and Value
        if Value == None:
            Value = self.get_fields(FieldKey)[5]  # get the 'missing' default
        ...
        if Ref != None:
            if isinstance(Ref, str) and TypeMultiplier:
                ...
                if (len(Ref) == 1 and not TypeMultiplier) or (
                    len(Ref) == 2 and TypeMultiplier
                ):
                    K = self.get_fields(Ref[0])[3]
                else:
                    raise STDFError(
                        "%s._pack_item(%s) : Unsupported Reference '%s' vs '%s'"
                        % (self.id, FieldKey, Ref, TypeFormat)
                    )
            else:
                raise STDFError(
                    "%s._pack_item(%s) : Unsupported Reference '%s' vs '%s'"
        ...
        if Type == "U":  # (list of) Unsigned integer(s)
            ...
            if Size.isdigit():
                if Size == "1":
                    ...
                    fmt = (
                        "%sI" % self.endian
                    )  # 4 byte unsigned integer(s) 0 .. 4.294.967.295
                elif Size == "8":
                    fmt = (
                        "%sQ" % self.endian
                    )  # 8 byte unsigned integer(s) 0 .. 18446744073709551615
                else:
                    if TypeMultiplier:
                        raise STDFError(
                            "%s._pack_item(%s) : Unsupported type-format '%s'"
            ...
            if self.local_debug:
                if TypeMultiplier:
                    ...
                    print(
                        "%s._pack_item(%s)\n   '%s' [%s]\n   %s bytes"
                        % (self.id, FieldKey, hexify(pkg), TypeFormat, len(pkg))
                    )
            ...
            if Size.isdigit():
                if Size == "1":
                    ...
                    fmt = (
                        "%sh" % self.endian
                    )  # 2 byte signed integer(s) -32.768 .. +32.767
                elif Size == "4":
                    fmt = (
                        "%si" % self.endian
                    )  # 4 byte signed integer(s) -2.147.483.648 .. +2.147.483.647
                elif Size == "8":
                    fmt = (
                        "%sq" % self.endian
                    )  # 8 byte signed integer(s) -9.223.372.036.854.775.808 .. +9.223.372.036.854.775.807
                else:
                    if TypeMultiplier:
                        raise STDFError(
                            "%s._pack_item(%s) : Unsupported type-format '%s'"
            ...
            if Size.isdigit():
                if Size == "4":
                    fmt = (
                        "%sf" % self.endian
                    )  # (list of) 4 byte floating point number(s) [float]
                elif Size == "8":
                    fmt = (
                        "%sd" % self.endian
                    )  # (list of) 8 byte floating point number(s) [double]
                else:
                    if TypeMultiplier:
                        raise STDFError(
                            "%s._pack_item(%s) : Unsupported type-format '%s'"
            ...
            if Size.isdigit() or Size == "f" or Size == "n":
                for i in range(K):
                    ...
                    bytes_to_pack = (
                        bits_to_pack // 8
                    )  # Bits to pack should always be a multiple of 8, guaranteed by set_value
                    if Size == "n":
            ...
            if Size == "n":
                ...
                if v == None:
                    raise STDFError(
                        "{self.id}._pack_item({FieldKey}) : There is no value set"
                    )
                ...
                for i in range(size):
                    ...
                    if code < 9:
                        ...
                        if len(value) == 1:
                            ...
                            raise STDFError(
                                "%s._pack_item(%s) : Only 2 nibbles are supported for code 13 type '%s'"
                                % (self.id, FieldKey, TypeFormat)
                            )
    ...
    def _unpack_item(self, FieldID):
        if len(self.buffer) == 0:
            ...
            if isinstance(FieldID, int):
                ...
                if FieldKey == "":
                    raise STDFError(
                        "%s._unpack_item(%s) : not a valid integer key"
                        % (self.id, FieldID)
                    )
            elif isinstance(FieldID, str):
                if FieldID not in self.fields:
                    raise STDFError(
                        "%s._unpack_item(%s) : not a valid string key"
                        % (self.id, FieldID)
                    )
                else:
                    FieldKey = FieldID
                ...
                raise STDFError(
                    "%s._unpack_item(%s) : not a string or integer key."
                    % (self.id, FieldID)
                )
                ...
                if Type == "xU":  # list of unsigned integers
                    if Bytes.isdigit():
                        if Bytes == "1":
                            fmt = (
                                self.endian + "B"
                            )  # list of one byte unsigned integers 0..255
                        elif Bytes == "2":
                            fmt = (
                                self.endian + "H"
                            )  # list of 2 byte unsigned integers 0..65535
                        elif Bytes == "4":
                            fmt = (
                                self.endian + "I"
                            )  # list of 4 byte unsigned integers 0..4294967295
                        elif Bytes == "8":
                            fmt = (
                                self.endian + "Q"
                            )  # list of 8 byte unsigned integers 0..18446744073709551615
                        else:
                            raise STDFError(
                                "%s._unpack_item(%s) : Unsupported type '%s'"
                                % (self.id, FieldKey, str(K) + "*".join((Type, Bytes)))
                            )
                    else:
                        raise STDFError(
                    ...
                    if Bytes.isdigit():
                        if Bytes == "1":
                            fmt = (
                                self.endian + "b"
                            )  # list of one byte signed integers -127..127
                        elif Bytes == "2":
                    ...
                    if Bytes.isdigit():
                        if Bytes == "4":
                            fmt = (
                                self.endian + "f"
                            )  # list of 4 byte floating point numbers (float)
                        elif Bytes == "8":
                            fmt = (
                                self.endian + "d"
                            )  # list of 8 byte floating point numbers (double)
                        else:
                            raise STDFError(
                                "%s._unpack_item(%s) : Unsupported type '%s'"
                                % (self.id, FieldKey, str(K) + "*".join((Type, Bytes)))
                    ...
                    if Bytes.isdigit():
                        if int(Bytes) <= 255:
                            raise STDFError(
                                "%s._unpack_item(%s) : Unimplemented type '%s'"
                                % (self.id, FieldKey, str(K) + "*".join((Type, Bytes)))
                            )
                        else:
                            raise STDFError(
                    ...
                    if Bytes.isdigit():
                        ...
                        for i in range(K):
                            ...
                            if code < 9:
                                ...
                                n_bits = struct.unpack(
                                    "%sH" % self.endian, working_buffer
                                )[0]
                    ...
                    raise STDFError(
                        "%s._pack_item(%s) : Unsupported type '%s'"
                        % (self.id, FieldKey, str(K) + "*".join((Type, Bytes)))
                    )
            else:
                if Type == "U":  # unsigned integer
                    ...
                    if Bytes.isdigit():  # B*1 B*2 ...
                        ...
                        self.buffer = self.buffer[int(Bytes) :]
                        temp = struct.unpack(
                            "B" * int(Bytes), working_buffer
                        )  # temp is a list (tuple) of 'Bytes' unsigned 1 byte bytes
                        ...
                        raise STDFError(
                            "%s._pack_item(%s) : Unimplemented type '%s'"
                            % (self.id, FieldKey, "*".join((Type, Bytes)))
                        )
                    else:
                        raise STDFError(
                    ...
                    if Bytes.isdigit():
                        ...
                        for index in range(len(working_buffer)):
                            B = struct.unpack(
                                "%sB" % self.endian, working_buffer[index]
                            )[0]
                            N1 = B & 0x0F
                            N2 = (B & 0xF0) >> 4
                            brol.append(N1)
    ...
    def _unpack(self, record):
        ...
        if self.local_debug:
            print(
                "%s._unpack(%s) with buffer length = %s"
                % (self.id, hexify(record), len(record))
            )

        if record[2] != self.fields["REC_TYP"]["Value"]:
            raise STDFError(
                "%s_unpack(%s) : REC_TYP doesn't match record" % hexify(record)
            )

        if record[3] != self.fields["REC_SUB"]["Value"]:
            raise STDFError(
                "%s_unpack(%s) : REC_SUB doesn't match record"
                % (self.id, hexify(record))
            )
    ...
    def Vn_decode(self, BUFF, endian):
        ...
        while len(buffer_remainer) != 0:
            ...
            if local_type == 0:  # B*0 Special pad field, of length 0
                ...
                (retval[index]["Value"],) = struct.unpack(
                    "%sB" % buffer_endian, working_buffer
                )
                index += 1
                ...
                (retval[index]["Value"],) = struct.unpack(
                    "%sH" % buffer_endian, working_buffer
                )
                index += 1
                ...
                (retval[index]["Value"],) = struct.unpack(
                    "%sI" % buffer_endian, working_buffer
                )
                index += 1
                ...
                (retval[index]["Value"],) = struct.unpack(
                    "%sf" % buffer_endian, working_buffer
                )
                index += 1
                ...
                (retval[index]["Value"],) = struct.unpack(
                    "%sd" % buffer_endian, working_buffer
                )
                index += 1
            elif (
                local_type == 10
            ):  # C*n Variable length ASCII character string (first byte is string length in bytes)
                working_buffer = buffer_remainer[0:1]
                buffer_remainer = buffer_remainer[1:]
                ...
                local_type == 11
            ):  # B*n Variable length binary data string (first byte is string length in bytes)
                working_buffer = buffer_remainer[0:1]
                buffer_remainer = buffer_remainer[1:]
                ...
                local_type == 12
            ):  # D*n Bit encoded data (first two bytes of string are length in bits)
                working_buffer = buffer_remainer[0:2]
                buffer_remainer = buffer_remainer[2:]
                ...
                (retval[index]["Value"],) = (
                    struct.unpack("%sB" % buffer_endian, working_buffer) & 0x0F
                )
                index += 1
            else:
                raise STDFError(
                    "Vn_decode() : unsupported type '%d' in V*n" % local_type
                )
        return retval
    ...
    def __repr__(self):
        ...
        if self.get_fields("REC_LEN")[3] != len(body):
            raise STDFError(
                "%s.pack() length error %s != %s"
                % (self.id, self.get_fields("REC_LEN")[3], len(body))
            )
        ...
        if self.local_debug:
            print(
                "%s.pack()\n   '%s'\n   %s bytes"
                % (self.id, hexify(retval), len(retval))
            )
        return retval
    ...
    def __str__(self):
        ...
        retval = "   %s (%d,%d) @ %s\n" % (
            self.id,
            self.get_value("REC_TYP"),
            self.get_value("REC_SUB"),
            self.version,
        )
        for field in sorted(sequence):
            retval += "      %s = '%s'" % (
                sequence[field],
                self.fields[sequence[field]]["Value"],
            )
            retval += " [%s] (%s)" % (
                self.fields[sequence[field]]["Type"],
                self.fields[sequence[field]]["Text"].strip(),
            )
            ...
            if sequence[field] in time_fields:
                ...
                retval += " = %s" % _stdf_time_field_value_to_string(
                    float(self.fields[sequence[field]]["Value"])
                )
            retval += "\n"
        return retval
    ...
    def to_dict(self, include_missing_values=False):
        ...
        for field in self.fields:
            sequence[self.fields[field]["#"]] = field
        return {
            sequence[field]: self.fields[sequence[field]]["Value"] for field in sequence
        }
    ...
    def reset(self):
        ...
        """
        for field in self.fields:
            if field == "REC_TYP" or field == "REC_SUB":
                continue
    ...
    def _missing_stdf_time_field_value(self) -> int:
        return int(
            time.time()
        )  # used to be DT().epoch, which returned time.time(). note that we need an 32bit unsigned integer to allow de-/serialization without data loss
...
"""
            self.fields = {
                ...
                "ASR_IDX": {
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Unique identifier for this ASR record               ",
                    "Missing": 0,
                    "Note": "",
                },
                "STRT_IDX": {
                ...
                "ALGO_CNT": {
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "count (k) of Algorithms descriptions                ",
                    "Missing": 0,
                    "Note": "",
                },
                "ALGO_NAM": {
                    ...
                    "Ref": "ALGO_CNT",
                    "Value": None,
                    "Text": "Array of Names of the Algorithms                    ",
                    "Missing": [],
                    "Note": "",
                },
                "ALGO_LEN": {
                    ...
                    "Ref": "ALGO_CNT",
                    "Value": None,
                    "Text": "Array of Complexity of algorithm  (e.g., 13N)       ",
                    "Missing": [],
                    "Note": "",
                },
                "FILE_ID": {
                    ...
                    "Ref": "ALGO_CNT",
                    "Value": None,
                    "Text": "Array of Name of the file with algorithm description",
                    "Missing": [],
                    "Note": "",
                },
                "CYC_BGN": {
                    ...
                    "Ref": "ALGO_CNT",
                    "Value": None,
                    "Text": "Array of Starting cycle number for the Algorithms   ",
                    "Missing": [],
                    "Note": "",
                },
                "CYC_END": {
                    ...
                    "Ref": "ALGO_CNT",
                    "Value": None,
                    "Text": "Array of End Cycle number for the algorithm         ",
                    "Missing": [],
                    "Note": "",
                },
            }
...
"""
            self.fields = {
                ...
                "BSR_IDX": {
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Unique ID for this Bit stream         ",
                    "Missing": 0,
                },
                "BIT_TYP": {
                    "#": 4,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Meaning of bits in the stream         ",
                    "Missing": 0,
                },
                "ADDR_SIZ": {
                    "#": 5,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Address field size [1,2,4 or 8]       ",
                    "Missing": 0,
                },
                "WC_SIZ": {
                    "#": 6,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Word Count Field Size [1,2,4 or 8]    ",
                    "Missing": 0,
                },
                "WRD_SIZ": {
                    "#": 7,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Number of bits used in the word field ",
                    "Missing": 0,
                },
            }
        else:
...
"""
            self.fields = {
                ...
                "CONT_FLG": {
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Continuation CDR record follow (if!=0)",
                    "Missing": 0,
                },
                "CDR_INDX": {
                    "#": 4,
                ...
                "CHN_LEN": {
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Chain Length (cells in chain)         ",
                    "Missing": 0,
                },
                "SIN_PIN": {
                    "#": 7,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "PMR index of the chain's Scan In Sig  ",
                    "Missing": 0,
                },
                "SOUT_PIN": {
                    "#": 8,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "PMR index of the chain's Scan Out Sig ",
                    "Missing": 0,
                },
                "MSTR_CNT": {
                    "#": 9,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Count (m) of master clock pins        ",
                    "Missing": 0,
                },
                "M_CLKS": {
                    "#": 10,
                    ...
                    "Ref": "MSTR_CNT",
                    "Value": None,
                    "Text": "Arr of PMR indses for the master clks ",
                    "Missing": [],
                },
                "SLAV_CNT": {
                    "#": 11,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Count (n) of slave clock pins         ",
                    "Missing": 0,
                },
                "S_CLKS": {
                    "#": 12,
                    ...
                    "Ref": "SLAV_CNT",
                    "Value": None,
                    "Text": "Arr of PMR indxes for the slave clks  ",
                    "Missing": [],
                },
                "INV_VAL": {
                    "#": 13,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "0: No Inversion, 1: Inversion         ",
                    "Missing": 0,
                },
                "LST_CNT": {
                    "#": 14,
...
"""
            self.fields = {
                ...
                "CHN_NUM": {
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Chain number. (cfr STR:CHN_NUM)       ",
                    "Missing": 0,
                },
                "BIT_POS": {
                    "#": 2,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Bit position in the chain             ",
                    "Missing": 0,
                },
                "CELL_NAM": {
                    "#": 2,
...
"""
            self.fields = {
                ...
                "BSR_IDX": {
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Unique ID this Bit stream spec.       ",
                    "Missing": 0,
                },
                "BIT_TYP": {
                    "#": 2,
                ...
                "ADDR_SIZ": {
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Address field size [1,2,4 & 8] are ok ",
                    "Missing": 0,
                },
                "WC_SIZ": {
                    "#": 2,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Word Count Field Size [1,2,4 & 8]     ",
                    "Missing": 0,
                },
                "WRD_SIZ": {
                    "#": 2,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Number of bits in word field          ",
                    "Missing": 0,
                },
            }
        else:
...
"""
            self.fields = {
                ...
                "REF_COD": {
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "0=Wafer Notch based, 1=Pkg ref        ",
                    "Missing": None,
                },
                "ORNT_COD": {
                    "#": 6,
                ...
                "MDL_FILE": {
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Pointer to file describing model      ",
                    "Missing": "",
                },
                "MDL_REF": {
                    "#": 8,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Reference to the model record         ",
                    "Missing": None,
                },
            }
        else:
...
"""
            self.fields = {
                ...
                "CTRL_IDX": {
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Index of this memory controller record",
                    "Missing": None,
                },
                "CTRL_NAM": {
                    "#": 4,
                ...
                "MDL_FILE": {
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Pointer to the file describing model  ",
                    "Missing": "",
                },
                "INST_CNT": {
                    "#": 6,
                ...
                "INST_LST": {
                    ...
                    "Ref": "INST_CNT",
                    "Value": None,
                    "Text": "Array of memory instance indexes      ",
                    "Missing": [],
                },
            }
        else:
...
"""
            self.fields = {
                ...
                "ALGO_NAM": {
                    ...
                    "Ref": "ALGO_CNT",
                    "Value": None,
                    "Text": "Array of Names Name of the Algorithm  ",
                    "Missing": [],
                },
                "ALGO_LEN": {
                    "#": 7,
                    ...
                    "Ref": "ALGO_CNT",
                    "Value": None,
                    "Text": "Array of Complexity of algorithm      ",
                    "Missing": [],
                },
                "FILE_ID": {
                    "#": 8,
                    ...
                    "Ref": "ALGO_CNT",
                    "Value": None,
                    "Text": "Array of Name of the file with descr. ",
                    "Missing": [],
                },
                "CYC_BGN": {
                    "#": 9,
                    ...
                    "Ref": "ALGO_CNT",
                    "Value": None,
                    "Text": "Array of Starting cycle number        ",
                    "Missing": [],
                },
                "CYC_END": {
                    "#": 10,
                    ...
                    "Ref": "ALGO_CNT",
                    "Value": None,
                    "Text": "Array of End Cycle number             ",
                    "Missing": [],
                },
            }
        else:
...
"""
            self.fields = {
                ...
                "NAME": {
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Name of the design under test         ",
                    "Missing": "",
                },
                "FILE_NAM": {
                    "#": 4,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Filename containing design information",
                    "Missing": "",
                },
                "CTRL_CNT": {
                    "#": 5,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Count (k) of controllers in the design",
                    "Missing": 0,
                },
                "CTRL_LST": {
                    "#": 6,
                    ...
                    "Ref": "CTRL_CNT",
                    "Value": None,
                    "Text": "Array of controller record indexes    ",
                    "Missing": [],
                },
                "INST_CNT": {
                    "#": 7,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Count(m) of Top level memory instances",
                    "Missing": 0,
                },
                "INST_LST": {
                    "#": 8,
                    ...
                    "Ref": "INST_CNT",
                    "Value": None,
                    "Text": "Array of Instance record indexes      ",
                    "Missing": [],
                },
            }
        else:
...
"""
            ...
            self.fields = {
                ...
                "LOG_TYP": {
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "User defined description of datalog   ",
                    "Missing": "",
                },
                "TEST_TXT": {
                    "#": 10,
                ...
                "CYC_CNT": {
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Total cycles executed during the test ",
                    "Missing": 0,
                },
                "TOTF_CNT": {
                    "#": 17,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Total fails during the test           ",
                    "Missing": 0,
                },
                "TOTL_CNT": {
                    "#": 18,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Total fails during the complete MTR   ",
                    "Missing": 0,
                },
                "OVFL_FLG": {
                    "#": 19,
                ...
                "FDIM_CNT": {
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Count (m) of FDIM_FNAM and FDIM_FCNT  ",
                    "Missing": 0,
                },
                "FDIM_NAM": {
                    "#": 23,
                    ...
                    "Ref": "FDIM_CNT",
                    "Value": None,
                    "Text": "Array of logged Dim names             ",
                    "Missing": [],
                },
                "FDIM_FCNT": {
                    "#": 24,
                ...
                "CYC_BASE": {
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Cycle offset to CYC_OFST array        ",
                    "Missing": 0,
                },
                "CYC_SIZE": {
                    "#": 26,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Size (f) of CYC_OFST [1,2,4 or 8 byes]",
                    "Missing": 1,
                },
                "PMR_SIZE": {
                    "#": 27,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Size (f) of PMR_ARR [1 or 2 bytes]    ",
                    "Missing": 1,
                },
                "ROW_SIZE": {
                    "#": 28,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Size (f) of ROW_ARR [1,2,4 or 8 bytes]",
                    "Missing": 1,
                },
                "COL_SIZE": {
                    "#": 29,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Size (f) of COL_ARR [1,2,4 or 8 bytes]",
                    "Missing": 1,
                },
                "DLOG_MSK": {
                    "#": 30,
                ...
                "PMR_CNT": {
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Count (n) of pins in PMN_ARR          ",
                    "Missing": 0,
                },
                "PMR_ARR": {
                    "#": 32,
                    "Type": "xU*f",
                    "Ref": ("PMR_CNT", "PMR_SIZE"),
                    "Value": None,
                    "Text": "Array of PMR indexes for pins         ",
                    "Missing": [],
                },
                "CYCO_CNT": {
                    "#": 33,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Count (n) of CYC_OFST array           ",
                    "Missing": 0,
                },
                "CYC_OFST": {
                    "#": 34,
                    "Type": "xU*f",
                    "Ref": ("CYCO_CNT", "CYC_SIZE"),
                    "Value": None,
                    "Text": "Array of cycle indexes for each fail  ",
                    "Missing": [],
                },
                "ROW_CNT": {
                    "#": 35,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Count (d) of ROW_ARR array            ",
                    "Missing": 0,
                },
                "ROW_ARR": {
                    "#": 36,
                    "Type": "xU*f",
                    "Ref": ("ROW_CNT", "ROW_SIZE"),
                    "Value": None,
                    "Text": "Array of row addresses for each fail  ",
                    "Missing": [],
                },
                "COL_CNT": {
                    "#": 37,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Count (d) of COL_ARR array            ",
                    "Missing": 0,
                },
                "COL_ARR": {
                    "#": 38,
                    "Type": "xU*f",
                    "Ref": ("COL_CNT", "COL_SIZE"),
                    "Value": None,
                    "Text": "Array of col addresses for each fail  ",
                    "Missing": [],
                },
                "STEP_CNT": {
                    "#": 39,
                ...
                "STEP_ARR": {
                    ...
                    "Ref": "STEP_CNT",
                    "Value": None,
                    "Text": "Array of march steps for each fail    ",
                    "Missing": [],
                },
                "DIM_CNT": {
                    "#": 41,
                ...
                "DIM_DSIZ": {
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Size (f) of DIM_VALS [1,2,4or 8 bytes]",
                    "Missing": 1,
                },
                "DIM_VALS": {
                    "#": 45,
                    "Type": "xU*f",
                    "Ref": ("DIM_DCNT", "DIM_DSIZ"),
                    "Value": None,
                    "Text": "Array of data values for a dimension  ",
                    "Missing": [],
                },
                "TFRM_CNT": {
                    "#": 46,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Total frames in frame based logging   ",
                    "Missing": 0,
                },
                "TFSG_CNT": {
                    "#": 47,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Total segments across all records     ",
                    "Missing": 0,
                },
                "LFSG_CNT": {
                    "#": 48,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Local number of frame segments        ",
                    "Missing": 0,
                },
                "FRM_IDX": {
                    "#": 49,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Index of the frame record             ",
                    "Missing": 0,
                },
                "FRM_MASK": {
                    "#": 50,
                ...
                "FRM_CNT": {
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Count (q) of frame (curr frame & maks)",
                    "Missing": 0,
                },
                "LFBT_CNT": {
                    "#": 52,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Count(q) of bits stored in this record",
                    "Missing": 0,
                },
                "FRAMES": {
                    "#": 53,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Bit encoded data (curr FSR)           ",
                    "Missing": [],
                },
                "TBSG_CNT": {
                    "#": 54,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Number of logged bit stream segments  ",
                    "Missing": 0,
                },
                "LBSG_CNT": {
                    "#": 55,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "# of bit stream segmnts in this record",
                    "Missing": 0,
                },
                "BSR_IDX": {
                    "#": 56,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Index of the bit stream record        ",
                    "Missing": 0,
                },
                "STRT_ADR": {
                    "#": 57,
                    ...
                    "Ref": BSR__ADDR_SIZ,
                    "Value": None,
                    "Text": "Start row addr in the current segment ",
                    "Missing": 1,
                },
                "WORD_CNT": {
                    "#": 58,
                    ...
                    "Ref": BSR__WC_SIZ,
                    "Value": None,
                    "Text": "Word count in current stream segment  ",
                    "Missing": 1,
                },
                "WORDS": {
                    "#": 59,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Bit encoded data for one or words     ",
                    "Missing": [],
                },
                "TBMP_SIZE": {
                    "#": 60,
                ...
                "LBMP_SIZE": {
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Bytes from map in the current record  ",
                    "Missing": 0,
                },
                "CBIT_MAP": {
                    "#": 62,
...
"""
            self.fields = {
                ...
                "CONT_FLG": {
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "NMR record(s) following if not 0      ",
                    "Missing": 0,
                },
                "TOTM_CNT": {
                    "#": 4,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Count of PMR indexes (=ATPG_NAMes)    ",
                    "Missing": 0,
                },
                "LOCM_CNT": {
                    "#": 5,
                ...
                "ATPG_NAM": {
                    ...
                    "Ref": "LOCM_CNT",
                    "Value": None,
                    "Text": "Array of ATPG signal names            ",
                    "Missing": [],
                },
            }
        else:
...
"""
            self.fields = {
                ...
                "CONT_FLG": {
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "PSR record(s) to follow if not 0      ",
                    "Missing": ["0"] * 8,
                },
                "PSR_INDX": {
                    "#": 4,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "PSR Record Index (used by STR records)",
                    "Missing": None,
                },
                "PSR_NAM": {
                    "#": 5,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Symbolic name of PSR record           ",
                    "Missing": "",
                },
                "OPT_FLG": {
                    "#": 6,
                ...
                "TOTP_CNT": {
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Count of sets in the complete data set",
                    "Missing": 1,
                },
                "LOCP_CNT": {
                    "#": 8,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Count (k) of sets in this record      ",
                    "Missing": 0,
                },
                "PAT_BGN": {
                    "#": 9,
                    ...
                    "Ref": "LOCP_CNT",
                    "Value": None,
                    "Text": "Array of Cycle #'s patterns begins on ",
                    "Missing": [],
                },
                "PAT_END": {
                    "#": 10,
                    ...
                    "Ref": "LOCP_CNT",
                    "Value": None,
                    "Text": "Array of Cycle #'s patterns stops at  ",
                    "Missing": [],
                },
                "PAT_FILE": {
                    "#": 11,
                    ...
                    "Ref": "LOCP_CNT",
                    "Value": None,
                    "Text": "Array of Pattern File Names           ",
                    "Missing": [],
                },
                "PAT_LBL": {
                    "#": 12,
                    ...
                    "Ref": "LOCP_CNT",
                    "Value": None,
                    "Text": "Optional pattern symbolic name        ",
                    "Missing": [],
                },
                "FILE_UID": {
                    "#": 13,
                    ...
                    "Ref": "LOCP_CNT",
                    "Value": None,
                    "Text": "Optional array of file identifier code",
                    "Missing": [],
                },
                "ATPG_DSC": {
                    "#": 14,
                    ...
                    "Ref": "LOCP_CNT",
                    "Value": None,
                    "Text": "Optional array of ATPG information    ",
                    "Missing": [],
                },
                "SRC_ID": {
                    "#": 15,
                    ...
                    "Ref": "LOCP_CNT",
                    "Value": None,
                    "Text": "Optional array of PatternInSrcFileID  ",
                    "Missing": [],
                },
            }
        else:
...
"""
            self.fields = {
                ...
                "SSR_NAM": {
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Name of the STIL Scan Structure       ",
                    "Missing": "",
                },
                "CHN_CNT": {
                    "#": 4,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Count (k) of number of Chains         ",
                    "Missing": 0,
                },
                "CHN_LIST": {
                    "#": 5,
...
"""
            self.fields = {
                ...
                "CONT_FLG": {
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Continuation STRs follow (if not 0)   ",
                    "Missing": 0,
                },
                "TEST_NUM": {
                    "#": 4,
                ...
                "PSR_REF": {
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "PSR Index (Pattern Sequence Record)   ",
                    "Missing": 0,
                },
                "TEST_FLG": {
                    "#": 8,
                ...
                "FMU_FLG": {
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "MASK_MAP & FAL_MAP field status       ",
                    "Missing": ["0"] * 8,
                },
                "MASK_MAP": {
                    "#": 16,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Bit map of Globally Masked Pins       ",
                    "Missing": [],
                },
                "FAL_MAP": {
                    "#": 17,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Bit map of failures after buffer full ",
                    "Missing": [],
                },
                "CYC_CNT": {
                    "#": 18,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Total cycles executed in test         ",
                    "Missing": 0,
                },
                "TOTF_CNT": {
                    "#": 19,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Total failures (pin x cycle) detected ",
                    "Missing": 0,
                },
                "TOTL_CNT": {
                    "#": 20,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Total fails logged across all STR's   ",
                    "Missing": 0,
                },
                "CYC_BASE": {
                    "#": 21,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Cycle offset to apply to CYCL_NUM arr ",
                    "Missing": 0,
                },
                "BIT_BASE": {
                    "#": 22,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Offset to apply to BIT_POS array      ",
                    "Missing": 0,
                },
                "COND_CNT": {
                    "#": 23,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Count (g) of Test Conditions+opt spec ",
                    "Missing": 0,
                },
                "LIM_CNT": {
                    "#": 24,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Count (j) of LIM Arrays in cur. rec.  ",
                    "Missing": 0,
                },  # 1 = global
                "CYC_SIZE": {
                    "#": 25,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Size (f) [1,2,4 or 8] of  CYC_OFST    ",
                    "Missing": 1,
                },
                "PMR_SIZE": {
                    "#": 26,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Size (f) [1 or 2] of PMR_INDX         ",
                    "Missing": 1,
                },
                "CHN_SIZE": {
                    "#": 27,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Size (f) [1, 2 or 4] of CHN_NUM       ",
                    "Missing": 1,
                },
                "PAT_SIZE": {
                    "#": 28,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Size (f) [1,2, or 4] of PAT_NUM       ",
                    "Missing": 1,
                },
                "BIT_SIZE": {
                    "#": 29,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Size (f) [1,2, or 4] of BIT_POS       ",
                    "Missing": 1,
                },
                "U1_SIZE": {
                    "#": 30,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Size (f) [1,2,4 or 8] of USR1         ",
                    "Missing": 1,
                },
                "U2_SIZE": {
                    "#": 31,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Size (f) [1,2,4 or 8] of USR2         ",
                    "Missing": 1,
                },
                "U3_SIZE": {
                    "#": 32,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Size (f) [1,2,4 or 8] of USR3         ",
                    "Missing": 1,
                },
                "UTX_SIZE": {
                    "#": 33,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Size (f) of each string in USER_TXT   ",
                    "Missing": 0,
                },
                "CAP_BGN": {
                    "#": 34,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Offset to BIT_POS to get capture cycls",
                    "Missing": 0,
                },
                "LIM_INDX": {
                    "#": 35,
                    ...
                    "Ref": "LIM_CNT",
                    "Value": None,
                    "Text": "Array of PMR unique limit specs       ",
                    "Missing": [],
                },
                "LIM_SPEC": {
                    "#": 36,
                    ...
                    "Ref": "LIM_CNT",
                    "Value": None,
                    "Text": "Array of fail datalog limits for PMR's",
                    "Missing": [],
                },
                "COND_LST": {
                    "#": 37,
                    ...
                    "Ref": "COND_CNT",
                    "Value": None,
                    "Text": "Array of test condition (Name=value)  ",
                    "Missing": [],
                },
                "CYC_CNT": {
                    "#": 38,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Count (k) of entries in CYC_OFST array",
                    "Missing": 0,
                },
                "CYC_OFST": {
                    "#": 39,
                    "Type": "xU*f",
                    "Ref": ("CYC_CNT", "CYC_SIZE"),
                    "Value": None,
                    "Text": "Array of cycle nrs relat to CYC_BASE  ",
                    "Missing": [],
                },
                "PMR_CNT": {
                    "#": 40,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Count (k) of entries in the PMR_INDX  ",
                    "Missing": 0,
                },
                "PMR_INDX": {
                    "#": 41,
                    ...
                    "Ref": ("PMR_CNT", "PMR_SIZE"),
                    "Value": None,
                    "Text": "Array of PMR Indexes (All Formats)    ",
                    "Missing": [],
                },
                "CHN_CNT": {
                    "#": 42,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Count (k) of entries in the CHN_NUM   ",
                    "Missing": 0,
                },
                "CHN_NUM": {
                    "#": 43,
                    "Type": "xU*f",
                    "Ref": ("CHN_CNT", "CHN_SIZE"),
                    "Value": None,
                    "Text": "Array of Chain No for FF Name Mapping ",
                    "Missing": [],
                },
                "EXP_CNT": {
                    "#": 44,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Count (k) of EXP_DATA array entries   ",
                    "Missing": 0,
                },
                "EXP_DATA": {
                    "#": 45,
                    ...
                    "Ref": "EXP_CNT",
                    "Value": None,
                    "Text": "Array of expected vector data         ",
                    "Missing": [],
                },
                "CAP_CNT": {
                    "#": 46,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Count (k) of CAP_DATA array entries   ",
                    "Missing": 0,
                },
                "CAP_DATA": {
                    "#": 47,
                ...
                "NEW_CNT": {
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Count (k) of NEW_DATA array entries   ",
                    "Missing": 0,
                },
                "NEW_DATA": {
                    "#": 49,
                ...
                "PAT_CNT": {
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Count (k) of PAT_NUM array entries    ",
                    "Missing": 0,
                },
                "PAT_NUM": {
                    "#": 51,
                    "Type": "xU*f",
                    "Ref": ("PAT_CNT", "PAT_SIZE"),
                    "Value": None,
                    "Text": "Array of pattern # (Ptn/Chn/Bit fmt)  ",
                    "Missing": [],
                },
                "BPOS_CNT": {
                    "#": 52,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Count (k) of BIT_POS array entries    ",
                    "Missing": 0,
                },
                "BIT_POS": {
                    "#": 53,
                    "Type": "xU*f",
                    "Ref": ("BPOS_CNT", "BIT_SIZE"),
                    "Value": None,
                    "Text": "Array of chain bit (Ptn/Chn/Bit fmt)  ",
                    "Missing": [],
                },
                "USR1_CNT": {
                    "#": 54,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Count (k) of USR1 array entries       ",
                    "Missing": 0,
                },
                "USR1": {
                    "#": 55,
                    "Type": "xU*f",
                    "Ref": ("USR1_CNT", "U1_SIZE"),
                    "Value": None,
                    "Text": "Array of logged fail                  ",
                    "Missing": [],
                },
                "USR2_CNT": {
                    "#": 56,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Count (k) of USR2 array entries       ",
                    "Missing": 0,
                },
                "USR2": {
                    "#": 57,
                    "Type": "xU*f",
                    "Ref": ("USR2_CNT", "U2_SIZE"),
                    "Value": None,
                    "Text": "Array of logged fail                  ",
                    "Missing": [],
                },
                "USR3_CNT": {
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Count (k) of USR3 array entries       ",
                    "Missing": 0,
                },
                "USR3": {
                    "#": 59,
                    "Type": "xU*f",
                    "Ref": ("USR3_CNT", "U3_SIZE"),
                    "Value": None,
                    "Text": "Array of logged fail                  ",
                    "Missing": [],
                },
                "TXT_CNT": {
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Count (k) of USER_TXT array entries   ",
                    "Missing": 0,
                },
                "USER_TXT": {
                    "#": 61,
                    "Type": "xC*f",
                    "Ref": ("TXT_CNT", "UTX_SIZE"),
                    "Value": None,
                    "Text": "Array of logged fail                  ",
                    "Missing": [],
                },
...
def objects_from_indexed_file(FileName, index, records_of_interest=None):
    ...
    if not isinstance(FileName, str):
        raise STDFError("'%s' is not a string.")
    if not os.path.exists(FileName):
        raise STDFError("'%s' does not exist")
    ...
    if records_of_interest == None:
        ...
        raise STDFError(
            "objects_from_indexed_file(%s, index, records_of_interest) : Unsupported records_of_interest"
            % (FileName, records_of_interest)
        )
    for REC_ID in roi:
        if REC_ID in index:
            for fp in index[REC_ID]:
                OBJ = create_record_object(
                    version,
                    endian,
                    REC_ID,
                    get_record_from_file_at_position(fd, fp, RLF),
                )
                yield OBJ
...
def get_bytes_from_file(FileName, Offset, Number):
    ...
    if not isinstance(Offset, int):
        raise STDFError("Offset is not an integer")
    if not isinstance(Number, int):
        raise STDFError("Number is not an integer")
    if not os.path.exists(FileName):
        raise STDFError("'%s' does not exist")
