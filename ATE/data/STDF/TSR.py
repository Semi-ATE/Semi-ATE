...
"""
            self.fields = {
                ...
                "EXEC_CNT": {
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Number of test executions             ",
                    "Missing": 4294967295,
                },
                "FAIL_CNT": {
                    "#": 8,
                ...
                "SEQ_NAME": {
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Sequencer (program segment/flow) name ",
                    "Missing": "",
                },
                "TEST_LBL": {
                    "#": 12,
                ...
                "TEST_TIM": {
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Average test execution time in seconds",
                    "Missing": 0.0,
                },
                "TEST_MIN": {
                    "#": 15,
                ...
                "TEST_MAX": {
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Highest test result value             ",
                    "Missing": 0.0,
                },
                "TST_SUMS": {
                    "#": 17,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Sum of test result values             ",
                    "Missing": 0.0,
                },
                "TST_SQRS": {
                    "#": 18,
                    ...
                    "Ref": None,
                    "Value": None,
                    "Text": "Sum of squares of test result values  ",
                    "Missing": 0.0,
                },
            }
